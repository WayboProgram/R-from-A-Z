...
getwd()
setwd("C:\\Users\\marcg\\Desktop\\R\\R programming A-Z\\ggplot2")
getwd()
...
tail(movies)
str(movies)
summary(movies$AudienceRatings)

factor(movies$Year)
movies$Year <- factor(movies$Year) #aixi no et treu mean, median, etc. d'aquesta columna
summary(movies) 
